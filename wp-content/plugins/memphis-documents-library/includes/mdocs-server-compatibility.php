	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<table class="table table-hover table-striped table-bordered" >
				...
				<tr>
					<td><?php echo __('Recommended Maxim PHP Input Vars', 'memphis-documents-library').'<br><small><i>'.__('Your current max_input_vars value is','memphis-documents-library'); echo  ': <b>'.ini_get("max_input_vars").'</b></small></i>'; ?></td>
